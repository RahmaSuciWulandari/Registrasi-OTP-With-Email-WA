    ...
    Box(
        ...
        Column(
            ...
            Box(
                ...
                Image(
                    painter = painterResource(id = R.drawable.wel1),
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Temukan keterampilan baru \ndan raih masa depanmu.",
                        fontSize = 14.sp,
                    ...
                    Row(
                        ...
                        listOf(dotActive, dotInactive, dotInactive).forEach {
                            Box(
                                modifier = Modifier
                                    .size(8.dp)
                    ...
                    Button(
                        onClick = {navController.navigate(Screen.Welcome2.route)},
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(52.dp),
